...
test('publishes legacy-compatible and modern entry points', async () => {
  const [
    packageRoot,
    previewModern,
    previewLegacy,
    ...
    import('vue-markdown-kit'),
    import('vue-markdown-kit/preview'),
    import('vue-markdown-kit/lib/preview'),
    import('vue-markdown-kit/theme/github'),
    import('vue-markdown-kit/lib/theme/github.js'),
  ])
